...
const detail = StyleSheet.create({
  ...
  startBtn:      { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: BLUE, borderRadius: 20, paddingVertical: 22, width: "100%", marginBottom: 8, shadowColor: BLUE, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.5, shadowRadius: 20, elevation: 12 },
